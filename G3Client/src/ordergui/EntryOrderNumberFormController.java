...
public class EntryOrderNumberFormController {
		...
		if (orderNum.trim().isEmpty()) {
			...
			if (BiteMeClientCommunication.displayedOrder.getOrderNumber() == null) {
				...
				Pane root = loaderOfDisplayAndUpdateForm
						.load(getClass().getResource("/ordergui/EntryDisplayAndUpdateInfoForOrderForm.fxml").openStream());
				...
				scene.getStylesheets().add(
						getClass().getResource("/ordergui/EntryDisplayAndUpdateInfoForOrderForm.css").toExternalForm());
	...
	public void start(Stage primaryStage) throws Exception {
		Parent root = FXMLLoader.load(getClass().getResource("/ordergui/EntryOrderNumberForm.fxml"));

		Scene scene = new Scene(root);
		scene.getStylesheets().add(getClass().getResource("/ordergui/EntryOrderNumberForm.css").toExternalForm());
		primaryStage.setTitle("Order");
		primaryStage.setScene(scene);
		primaryStage.show();
	}
